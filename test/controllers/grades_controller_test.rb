...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { assignment: @grade.assignment, grade: @grade.grade, student_id: @grade.student_id, teacher_id: @grade.teacher_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { assignment: @grade.assignment, grade: @grade.grade, student_id: @grade.student_id, teacher_id: @grade.teacher_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
